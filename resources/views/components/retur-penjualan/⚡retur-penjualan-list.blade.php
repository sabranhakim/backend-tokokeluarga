                ...
                <tbody wire:loading.class="hidden" class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right space-x-3">
                            ...
                            <button wire:click="delete('{{ $returPenjualan->getKey() }}')" wire:confirm="Yakin ingin menghapus data ini?" class="text-red-600 hover:text-red-700 font-bold text-sm" title="Hapus">

                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            <button wire:click="restore('{{ $supplier->getKey() }}')" class="text-emerald-600 hover:text-emerald-700 font-medium" title="Restore">
                            ...
                            <button wire:click="forceDelete('{{ $supplier->getKey() }}')" wire:confirm="Yakin ingin menghapus permanen? Data tidak bisa dikembalikan!" class="text-red-600 hover:text-red-700 font-medium" title="Delete Permanently">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-6 py-10 text-center text-slate-500 italic text-sm">Trash supplier kosong.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>

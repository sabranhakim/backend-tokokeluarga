        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 overflow-y-auto py-6 space-y-1 custom-scrollbar px-3">
                ...
                <a href="{{ route('dashboard') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('dashboard') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('barang.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('barang.index') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                    <span>Stok Barang</span>
                </a>

                <a href="{{ route('barang-stok.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('barang-stok.index') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('barang.history-all') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('barang.history*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                    <span>Riwayat Stok</span>
                </a>

                <a href="{{ route('kategori.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('kategori.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('supplier.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('supplier.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('penerimaan.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('penerimaan.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('barang-keluar.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('barang-keluar.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
                    <span>Barang Keluar</span>
                </a>

                <a href="{{ route('retur-pembelian.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('retur-pembelian.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h2m4 0h6M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <span>Retur Pembelian</span>
                </a>

                <a href="{{ route('retur-penjualan.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('retur-penjualan.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('stock-opname.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('stock-opname.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2a4 4 0 00-4-4H5m14 0h-2a4 4 0 00-4 4v2m-2 4h.01M9 21h6a2 2 0 002-2V5a2 2 0 00-2-2H9a2 2 0 00-2-2H9a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                    <span>Stock Opname</span>
                </a>

                <a href="{{ route('laporan.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('laporan.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2a4 4 0 00-4-4H5m14 0h-2a4 4 0 00-4 4v2m-2 4h.01M9 21h6a2 2 0 002-2V5a2 2 0 00-2-2H9a2 2 0 00-2-2H9a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                    <span>Laporan</span>
                </a>
                ...
                <a href="{{ route('faq.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('faq.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('activity.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('activity.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('users.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('users.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">
                ...
                <a href="{{ route('roles.index') }}" 
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-colors {{ request()->routeIs('roles.*') ? 'sidebar-active' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-700' }}">

            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/40 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-center gap-2" wire:loading.class="opacity-50" wire:target="apply({{ $opname->id }})">
                                ...
                                @if($draft)
                                <button wire:click="apply('{{ $opname->id }}')" wire:confirm="Terapkan penyesuaian stok untuk stock opname ini?"
                                ...
                                @endif
                                <button wire:click="delete('{{ $opname->id }}')" wire:confirm="Hapus stock opname ini?"

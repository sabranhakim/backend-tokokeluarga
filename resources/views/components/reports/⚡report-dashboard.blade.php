...
<div class="p-8">
    <div class="flex jsustify-between items-center mb-6">
    ...
    <div class="mb-6 flex flex-wrap gap-4 items-end bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
        ...
        <div class="ml-auto">
            <button onclick="window.print()" class="flex items-center px-4 py-2 bg-slate-800 text-white rounded-lg text-sm font-bold hover:bg-slate-900 transition-all">

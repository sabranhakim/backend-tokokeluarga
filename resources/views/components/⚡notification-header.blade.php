...
<div x-data="{ open: false, openAll: false }" class="relative">
    ...
    <div x-show="openAll" @click.outside="openAll = false" x-transition.opacity class="fixed inset-0 z-[60] bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4" style="display: none;">

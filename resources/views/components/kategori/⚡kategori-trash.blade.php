...
<div class="p-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-sm text-slate-500">Kategori yang dihapus sementara</p>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        <td class="px-6 py-4 text-sm text-slate-500">#{{ $kategori->getKey() }}</td>
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            <button wire:click="restore('{{ $kategori->getKey() }}')" class="text-emerald-600 hover:text-emerald-700 font-medium" title="Restore">
                            ...
                            <button wire:click="forceDelete('{{ $kategori->getKey() }}')" wire:confirm="Yakin ingin menghapus permanen? Data tidak bisa dikembalikan!" class="text-red-600 hover:text-red-700 font-medium" title="Delete Permanently">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-6 py-10 text-center text-slate-500 italic text-sm">Trash kategori kosong.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
